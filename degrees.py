...
def load_data(directory):
    ...
    """
    # Load people
    with open(f"C:\\Users/User/Desktop/PythonFiles/degrees/{directory}/people.csv", encoding="utf-8") as f:
    ...
    # Load movies
    with open(f"C:\\Users/User/Desktop/PythonFiles/degrees/{directory}/movies.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            movies[row["id"]] = {
                "title": row["title"],
    ...
    # Load stars
    with open(f"C:\\Users/User/Desktop/PythonFiles/degrees/{directory}/stars.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            try:
